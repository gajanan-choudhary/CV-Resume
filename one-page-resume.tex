...
software development experience through 15\smallplus{}
...
and machine learning. Creator of 4 scientific software, contributor to 3 HPC
...
\section{Skills}
  \resumeSubItemListStart
    \resumeSubItem{Programming}{C/\CC{}, Python, Fortran, MATLAB, Bash, MPI,
...
\section{Projects}
  \resumeSubItemListStart
    \resumeSubItem{\href{https://github.com/gajanan-choudhary/water-coupler}{Water Coupler}}
    ...
    \resumeSubItem{Machine Learning}
      {Used \textbf{image processing} and \textbf{neural networks} to detect

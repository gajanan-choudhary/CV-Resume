...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    %---------------------------------Title------------------------------------%
    \resumeSubheading{Research Associate}{\dates{December 2020}{Present}}
 
      %-------------------------------Job 4------------------------------------%
      \resumeSubSubheading{\textbf{The University of Texas at Austin}}{Austin, TX}
        \resumeItemListStart
          \resumeUnlabeledItem{Leading the development of coupled PyTorch
          ...
          \resumeUnlabeledItem{Leading software projects that the US Army Corps
            of Engineers (USACE) is sponsoring to expand the capabilities of
      ...
      \resumeSubSubheading{\textbf{Indian Institute of Technology (IIT) Kharagpur}}{Kharagpur, India}
        \resumeItemListStart
          ...
          \resumeUnlabeledItem{Proposed improvements to genetic algorithms for
            ...
            complex benchmark problems in literature.}
          \resumeUnlabeledItem{Supported the research of a PhD student by
            creating FE models of sandwich materials subject to explosions.}
        \resumeItemListEnd
  \resumeSubHeadingListEnd
\vspace{-4pt}
...
\section{Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading{Software development:}{}
      \resumeItemListStart
        \resumeItem{Programming}{C/\CC{}, Python, Fortran, MATLAB,
    ...
    \resumeSubheading{Research:}{}
      \resumeItemListStart
        ...
        \resumeItem{Applications}
          {ANSYS, Abaqus, ParaView, AutoCAD, Adaptive Hydraulics (AdH),
          ADvanced CIRCulation (ADCIRC), Gridded Surface Subsurface Hydrologic
          Analysis (GSSHA), and Aquaveo SMS/WMS.}
      \resumeItemListEnd
